  ...
  render() {
    return (
      <React.Fragment>
        ...
        <div
          className={
            !this.state.power ? `container-disabled container` : `container`
          }
          id="drum-machine"
        >
          <div className="drumpad-container">
            {Object.keys(mapping).map((item, i) => (
              <DrumPad
                id={"sound".concat(item)}
                key={i}
                value={item}
                src={url.concat(mapping[item]).concat(".mp3")}
                volume={this.state.volume}
                onPlay={this.updateDisplay}
          ...
          <div id="control-container">
            <div id="powerBar">
              ...
              <Toggle
                changeHandler={this.togglePower}
            ...
            <div id="volumeBar">
              <RangeInput
                changeHandler={this.changeVolume}
                volume={this.state.volume}
                disabled={!this.state.power}
              />
            </div>
